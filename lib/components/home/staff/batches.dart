...
class StaffBatches extends ConsumerStatefulWidget {
  final List<Map<String, Map<String, dynamic>>> batches;
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      CustomText(
                        text: widget
                            .batches[firstIndex].values.first.values.first
                            .toString(),
                      ...
                      CustomText(
                        text: widget
                            .batches[firstIndex].values.first.values.last
                            .toString(),
                        size: sizeData.regular,
                        color: colorData.fontColor(.8),
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(8),
                            child: Image.network(
                              widget.batches[index].keys.first,
                              width: height * 0.14,
                              fit: BoxFit.fill,
